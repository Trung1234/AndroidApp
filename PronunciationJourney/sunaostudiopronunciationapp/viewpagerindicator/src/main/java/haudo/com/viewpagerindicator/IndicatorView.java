...
public class IndicatorView extends View implements IndicatorInterface, ViewPager.OnPageChangeListener {
    ...
    public IndicatorView(Context context, AttributeSet attrs) {
        ...
        this.radiusSelected = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_haudo_radius_selected, DEFAULT_RADIUS_SELECTED);

        this.radiusUnselected = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_haudo_radius_unselected, DEFAULT_RADIUS_UNSELECTED);

        this.distance = typedArray.getInt(R.styleable.IndicatorView_haudo_distance, DEFAULT_DISTANCE);

        this.colorSelected = typedArray.getColor(R.styleable.IndicatorView_haudo_color_selected, Color.parseColor("#ffffff"));

        this.colorUnselected = typedArray.getColor(R.styleable.IndicatorView_haudo_color_unselected, Color.parseColor("#ffffff"));
